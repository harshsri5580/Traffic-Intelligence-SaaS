...
<h2 className="text-lg font-semibold mb-6">Campaign Settings</h2>

<div className="grid grid-cols-2 gap-4">

<input className="border p-2 rounded" placeholder="Campaign Name"
value={form.name}
...
<input className="border p-2 rounded" placeholder="Fallback URL"
